// 🌟 Blazor가 어느 순간에 호출해도 즉시 인지할 수 있도록 네임스페이스 선언 분리 및 확실한 바인딩
...
((exports) => {
    ...
    let _isZooming = false;     // 🌟 튕김 방지를 위한 가드 플래그
    ...
    exports.loadPdfBytes = async function (byteArray) {
    ...
    exports.setTool = function (color, size, isEraser, toolName) {
        _color = color;
        _size = size;
        _isEraser = isEraser;
        _tool = toolName;
    ...
    exports.getRect = function (pageNum) {
